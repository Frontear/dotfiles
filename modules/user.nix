{ config, lib, pkgs, username, ... }: {
    home-manager.users."${username}" = {
        ...
        programs.chromium = {
            ...
            commandLineArgs = [ "--disk-cache-dir=/tmp/chrome-cache" ];
        ...
        # TODO: xdg
        # TODO: necessity when plasma5 outside system?
        xdg.enable = true;
    };
    ...
    users = {
        ...
        mutableUsers = false;
        users."root".initialHashedPassword = config.users.extraUsers."${username}".initialHashedPassword;
    };
}
